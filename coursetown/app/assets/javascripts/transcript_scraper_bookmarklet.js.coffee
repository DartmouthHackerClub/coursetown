if window.location.href == 'https://banner.dartmouth.edu/banner/groucho/bwskotrn.P_ViewTran'
  app_root = 'http://coursetown.hacktown.cs.dartmouth.edu'
  submit_url = "#{app_root}reviews/from_transcript"
  login_check_url = "#{app_root}am_i_logged_in"
  course_picker_url = "#{app_root}auth/cas?callback=/reviews/from_transcript"
